...
The project's technical documentation helps interested parties, users 
and developers to understand the project, registering fundamental information and 
...
- **How to install and preview the documentation**: `README`_
...
`sphinx-rtd-theme`_, and is hosted on the `Read The Docs`_ service.
...
.. important::
    ...
    Don't hesitate to contribute with pull requests (PRs) for adjustments, complements
